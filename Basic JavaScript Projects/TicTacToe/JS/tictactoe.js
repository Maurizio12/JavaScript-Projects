...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            //if activePLayer is equal to O the o.png is placed on HTML
            select.style.backgroundImage = 'url("images/o.png")';
        }
        //squareNumbers and activePlayer are concatenated together and added to array
        selectedSquares.push(squareNumber + activePlayer);
        //This call a function to check any win conditions.
        checkWinConditions();
...
//drawLine() function is called to draw a line on the screen is the condition is met.
function checkWinConditions() {
    ...
    //This function checks if any array includes 3 strings. it is used to check for
    //each win condition.
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        //if the 3 variables we pass are all included in your array then
        //true is returned and our else if condition executs the drawLine () function.
        if (a === true && b === true && c === true) {return true; }
    }
}

// This function makes our body element temporarirly unclikable.
...
//This function takes a string parameter of the path as a parameter.
...
function drawWinLine (coordX1, coordY1, coordX2, coordY2) {
    ...
    x = x1,
    //This variable stores temporary y data we update in our animation loop.
    y = y1;
    ...
    function animateLineDrawing () {
        ...
        c.lineTo(x, y);
        //This line set the width of our line.
        c.lineWidth = 10;
        ...
        if (x1 <= x2 && y1 <= y2) {
            ...
            if (y < y2) {y += 10; }
            //This condition adds 10 to the previous end y endpoint.7
    ...
    animateLineDrawing();
    //This line waits 1 second. Then cleras canvas, reset game, and allows clicking again.
...
function resetGame () {
    ...
    for (let i = 0; i < 9; i++) {
        ...
        //This rempoves our elements backgroundImage.
